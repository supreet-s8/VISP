...
sub collector {
	...
	foreach my $type (keys %$adaptor) {
		...
		# was gzip previously
			"collector modify-instance 1 modify-adaptor $type modify-file-if f1 compression none",
			...
			"collector modify-instance 1 modify-adaptor $type stack-log-level 0"
                ...
                push(@cmds,"collector modify-instance 1 modify-adaptor pilotPacket modify-file-if f1 filename-format *_*_*_*_%YYYY%MM%DD%hh%mm%ss_B40_*.bin",
			"collector modify-instance 1 modify-adaptor pilotPacket modify-file-if f1 transfer-filename-fmt *_*_*_*_%YYYY%MM%DD%hh%mm%ss_B40_*.bin.tmp",
			"collector modify-instance 1 modify-adaptor ipfix modify-file-if f1 filename-format *_*_*_*_%YYYY%MM%DD%hh%mm%ss_HDR_*.csv",
			"collector modify-instance 1 modify-adaptor ipfix modify-file-if f1 transfer-filename-fmt *_*_*_*_%YYYY%MM%DD%hh%mm%ss_HDR_*.csv.tmp",
			...
			"pm process collector liveness hung-count 20",
			...
			"pm process collector launch environment set LD_LIBRARY_PATH /opt/hadoop/c++/Linux-amd64-64/lib:/usr/java/jre1.6.0_25/lib/amd64/server:/opt/tps/lib:/platform_latest/collector/lib",
			...
			"gn logging collector level notice",
			
		#--------- MOP fixes for FOA sites------#
			"internal set modify - /nr/collector/instance/1/adaptor/ipfix/num_threads value int16 6",
			"internal set modify - /nr/collector/instance/1/adaptor/pilotPacket/num_threads value int16 1",
			"internal set modify - /nr/logging/config/collector/current_level value uint16 5",
			"stats config partition /data/drbd",
			"logging local override class nr priority notice",
			"collector modify-instance 1 modify-adaptor ipfix peak-flow-alarm-threshold 30000",
...
#		"snmp-server host $$prop{server}{ip} traps version 2c $$prop{server}{community}",
	...
	foreach my $entry(keys %$snmpsrv) {
		...
		push (@cmds, "snmp-server host $$snmpsrv{$entry}{ip} traps version 2c $$prop{server}{community}") if (! $$snmpsrv{$entry}{community});
		push (@cmds, "snmp-server host $$snmpsrv{$entry}{ip} traps version 2c $$snmpsrv{$entry}{community}") if ($$snmpsrv{$entry}{community});
	}
...
sub oozie {
	...
	push (@cmds, "pmx subshell oozie set job Atlas attribute lastSuccessPath /data/local/LastSucessfulOutput");

	push(@cmds,"pmx subshell oozie set job Atlas action SubscriberIBCreator attribute binaryInput true",
	"pmx subshell oozie set job Atlas action SubscriberIBCreator attribute outputDataset pnsa_subib",
	"pmx subshell oozie set job Atlas action SubscriberIBCreator attribute inputDatasets pnsa_radius",
	"pmx subshell oozie set job Atlas action SubscriberIBCreator attribute selfIpCleanupDataset pnsa_selfipcleanup1",
	...
	"pmx subshell oozie set job Atlas action SubscriberIBCreator attribute jarFile /opt/tms/java/CubeCreator-atlas4.0.jar",
	...
	"pmx subshell oozie set job Atlas action SubscriberIBCreator attribute snapshotDatasets pnsa_subib",
	...
	"pmx subshell oozie set job Atlas action WngIBCreator attribute outputDataset visp_wngib",
	"pmx subshell oozie set job Atlas action WngIBCreator attribute inputDatasets visp_wng",
	"pmx subshell oozie set job Atlas action WngIBCreator attribute jarFile /opt/tms/java/CubeCreator-atlas4.0.jar",
	"pmx subshell oozie set job Atlas action WngIBCreator attribute mainClass com.guavus.mapred.atlas.job.wng.WngIBCreator",
	"pmx subshell oozie set job Atlas action WngIBCreator attribute snapshotDatasets visp_wngib",
	"pmx subshell oozie set job Atlas action WngIBCreator attribute configFile /opt/etc/oozie/AtlasCubes/WngIBCreator.xml",
	"pmx subshell oozie set job Atlas action BaseCubes attribute outputDataset visp_basecube",
	...
	"pmx subshell oozie set job Atlas action SubscriberibIpPortCleanup attribute outputDataset pnsa_ipportcleanup",
	"pmx subshell oozie set job Atlas action SubscriberibIpPortCleanup attribute inputDatasets pnsa_subib",
	...
	"pmx subshell oozie set job Atlas action SubscriberibIpPortCleanup attribute jarFile /opt/tms/java/CubeCreator-atlas4.0.jar",
	...
	"pmx subshell oozie set job Atlas action SubscriberibSelfIpCleanup attribute outputDataset pnsa_selfipcleanup",
	"pmx subshell oozie set job Atlas action SubscriberibSelfIpCleanup attribute inputDatasets pnsa_ipportcleanup",
	...
	"pmx subshell oozie set job Atlas action SubscriberibSelfIpCleanup attribute jarFile /opt/tms/java/CubeCreator-atlas4.0.jar",
	...
	"pmx subshell oozie set job Atlas action BaseCubes attribute inputDatasets pnsa_ipfix",
	"pmx subshell oozie set job Atlas action BaseCubes attribute inputDatasets pnsa_tcpfix",
	"pmx subshell oozie set job Atlas action BaseCubes attribute jarFile /opt/tms/java/CubeCreator-atlas4.0.jar",
	"pmx subshell oozie set job Atlas action BaseCubes attribute configFile /opt/etc/oozie/AtlasCubes/BaseCubes.xml",
	"pmx subshell oozie set job Atlas action SubcrBytesAgg attribute outputDataset visp_subbytes",
	"pmx subshell oozie set job Atlas action SubcrBytesAgg attribute inputDatasets visp_basecube",
	...
	"pmx subshell oozie set job Atlas action SubcrBytesAgg attribute jarFile /opt/tms/java/CubeCreator-atlas4.0.jar",
	...
	"pmx subshell oozie set job Atlas action TopN attribute outputDataset visp_topn",
	"pmx subshell oozie set job Atlas action TopN attribute mainClass com.guavus.mapred.atlas.job.TopNJob.TopN",
	"pmx subshell oozie set job Atlas action TopN attribute inputDatasets visp_basecube",
	"pmx subshell oozie set job Atlas action TopN attribute jarFile /opt/tms/java/CubeCreator-atlas4.0.jar",
	"pmx subshell oozie set job Atlas action TopN attribute configFile /opt/etc/oozie/AtlasCubes/TopN.json",
	"pmx subshell oozie set job Atlas action SubcrDev attribute outputDataset visp_subdev",
	"pmx subshell oozie set job Atlas action SubcrDev attribute inputDatasets visp_basecube",
	...
	"pmx subshell oozie set job Atlas action SubcrDev attribute jarFile /opt/tms/java/CubeCreator-atlas4.0.jar",
	"pmx subshell oozie set job Atlas action SubcrDev attribute snapshotDatasets visp_subdev",
	"pmx subshell oozie set job Atlas action SubcrDev attribute configFile /opt/etc/oozie/AtlasCubes/AtlasCubes.xml",
	"pmx subshell oozie set job Atlas action Rollup attribute outputDataset visp_rollup",
	"pmx subshell oozie set job Atlas action Rollup attribute inputDatasets visp_basecube",
	"pmx subshell oozie set job Atlas action Rollup attribute mainClass com.guavus.mapred.atlas.job.rollup.Main",
	"pmx subshell oozie set job Atlas action Rollup attribute topnDataset visp_topn",
	"pmx subshell oozie set job Atlas action Rollup attribute jarFile /opt/tms/java/CubeCreator-atlas4.0.jar",
